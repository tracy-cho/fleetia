...
const PrivacyPolicy: React.FC<PrivacyPolicyProps> = () => {
  return (
    <div>
      <p>
        &lt; 주식회사 온마이뎁 &gt;(&#x27;
        <a href="https://www.onmydev.com/">https://www.onmydev.com</a>&#x27;, ‘
        <a href="https://atsent.ai/">https://atsent.ai</a>’, ‘
        <a href="https://reviewaid.ai/">https://reviewaid.ai</a>’ 이하
        &#x27;온마이뎁&#x27;)은(는) 「개인정보 보호법」 제30조에 따라 정보주체의
      ...
      <p>
        ...
        <a href="https://atsent.ai/">https://atsent.ai</a>’, ‘
        <a href="https://reviewaid.ai/">https://reviewaid.ai</a>’ 이하
        &#x27;온마이뎁&#x27;)은(는) 다음의 목적을 위하여 개인정보를 처리합니다.
      ...
      <ul>
        <li style={{ listStyleType: "disc" }}>
          1. 홈페이지 회원가입 및 관리회원 가입의사 확인, 회원제 서비스 제공에
      ...
      <ul>
        <li style={{ listStyleType: "disc" }}>
          2. 민원사무 처리민원인의 신원 확인, 민원사항 확인, 사실조사를 위한
          연락·통지, 처리결과 통보 목적으로 개인정보를 처리합니다.
        </li>
      </ul>
      <ul>
        <li style={{ listStyleType: "disc" }}>
          3. 재화 또는 서비스 제공서비스 제공, 콘텐츠 제공, 맞춤서비스 제공,
          본인인증, 연령인증, 요금결제·정산을 목적으로 개인정보를 처리합니다.
        </li>
      </ul>
      <ul>
        <li style={{ listStyleType: "disc" }}>
          4. 마케팅 및 광고에의 활용신규 서비스(제품) 개발 및 맞춤 서비스 제공,
      ...
      <ul>
        <li style={{ listStyleType: "disc" }}>
          5. 개인영상정보범죄의 예방 및 수사 등을 목적으로 개인정보를
          처리합니다.
        </li>
      </ul>
      <p>제2조(개인정보의 처리 및 보유 기간)</p>
      <p>
        ① &lt; 주식회사 온마이뎁 &gt;은(는) 법령에 따른 개인정보 보유·이용기간
      ...
      <ul>
        <li style={{ listStyleType: "disc" }}>보유근거 : 관련법령</li>
      </ul>
      <ul>
        <li style={{ listStyleType: "disc" }}>
      ...
      <ul>
        <li style={{ listStyleType: "disc" }}>예외사유 :</li>
      </ul>
      <ul>
        <li style={{ listStyleType: "disc" }}>
          2.&lt;재화 또는 서비스 제공&gt;
      ...
      <p>
        ① &lt; 주식회사 온마이뎁 &gt;은(는) 개인정보를 제1조(개인정보의 처리
      ...
      <p>제4조(개인정보처리 위탁)</p>
      <p>
        ① &lt; 주식회사 온마이뎁 &gt;은(는) 위탁계약 체결시 「개인정보 보호법」
      ...
      <p>
        ① 정보주체는 주식회사 온마이뎁에 대해 언제든지 개인정보
        열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.
      </p>
      <p>
        ② 제1항에 따른 권리 행사는주식회사 온마이뎁에 대해 「개인정보 보호법」
        시행령 제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실
        수 있으며 주식회사 온마이뎁은(는) 이에 대해 지체 없이 조치하겠습니다.
      </p>
      <p>
      ...
      <p>
        ⑥ 주식회사 온마이뎁은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의
        요구, 처리정지의 요구 시 열람 등 요구를 한 자가 본인이거나 정당한
        대리인인지를 확인합니다.
      </p>
      <p>제6조(처리하는 개인정보의 항목 작성)</p>
      <p>
        ① &lt; 주식회사 온마이뎁 &gt;은(는) 다음의 개인정보 항목을 처리하고
        있습니다.
      </p>
      <ul>
        <li style={{ listStyleType: "disc" }}>
      ...
      <ul>
        <li style={{ listStyleType: "disc" }}>
          필수항목 : 이메일, 휴대전화번호, 비밀번호, 로그인ID, 이름, 회사명,
          서비스 이용 기록, 접속 로그, 접속 IP 정보, 결제기록
        </li>
      </ul>
      <ul>
        <li style={{ listStyleType: "disc" }}>선택항목 : 신용카드정보</li>
      </ul>
      <p>제7조(개인정보의 파기)</p>
      <p>
        ① &lt; 주식회사 온마이뎁 &gt; 은(는) 개인정보 보유기간의 경과, 처리목적
      ...
      <p>
        1. 법령 근거 : 전자상거래 등에서의 소비자보호에 관한 법률 제6조제3항
      </p>
      <p>2. 보존하는 개인정보 항목 : 계좌정보, 거래날짜</p>
      <p>③ 개인정보 파기의 절차 및 방법은 다음과 같습니다.</p>
      <p>1. 파기절차</p>
      <p>
        &lt; 주식회사 온마이뎁 &gt; 은(는) 파기 사유가 발생한 개인정보를
        선정하고, &lt; 주식회사 온마이뎁 &gt; 의 개인정보 보호책임자의 승인을
        받아 개인정보를 파기합니다.
      </p>
      <p>2. 파기방법</p>
      <p>
      ...
      <p>
        &lt; 주식회사 온마이뎁 &gt;은(는) 개인정보의 안전성 확보를 위해 다음과
        같은 조치를 취하고 있습니다.
      </p>
      ...
      <p>
        ① 주식회사 온마이뎁 은(는) 이용자에게 개별적인 맞춤서비스를 제공하기
      ...
      <p>제10조 (개인정보 보호책임자)</p>
      <p>
        ① 주식회사 온마이뎁 은(는) 개인정보 처리에 관한 업무를 총괄해서
        책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제 등을
        위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.
      </p>
      <ul>
        <li style={{ listStyleType: "disc" }}>▶ 개인정보 보호책임자</li>
      </ul>
      <ul>
        <li style={{ listStyleType: "disc" }}>성명 :박헌영</li>
      </ul>
      <ul>
        <li style={{ listStyleType: "disc" }}>직책 :CEO</li>
      </ul>
      <ul>
        <li style={{ listStyleType: "disc" }}>직급 :CEO</li>
      </ul>
      <ul>
        <li style={{ listStyleType: "disc" }}>
          연락처 :01085548902, phy@onmydev.com,
        </li>
      </ul>
      ...
      <ul>
        <li style={{ listStyleType: "disc" }}>부서명 : 감성분석사업팀</li>
      </ul>
      <ul>
        <li style={{ listStyleType: "disc" }}>담당자 : 우성재</li>
      </ul>
      <ul>
        <li style={{ listStyleType: "disc" }}>연락처 : sjwoo@onmydev.com</li>
      </ul>
      <p>
        ② 정보주체께서는 주식회사 온마이뎁 의 서비스(또는 사업)을 이용하시면서
        발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을
        개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. 주식회사
        온마이뎁 은(는) 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴
        것입니다.
      </p>
      <p>제11조(가명정보의 처리)</p>
      <p>
        &lt; 주식회사 온마이뎁 &gt; 은(는) 다음과 같은 목적으로 가명정보를
        처리하고 있습니다.
      </p>
      <p>▶ 가명정보의 처리 목적</p>
      <ul>
        <li style={{ listStyleType: "disc" }}>가명정보를 취급하지 않습니다.</li>
      </ul>
      <p>▶ 가명정보의 처리 및 보유기간</p>
      <ul>
        <li style={{ listStyleType: "disc" }}>가명정보를 취급하지 않습니다.</li>
      ...
      <p>① 이 개인정보처리방침은 2023년 12월 13부터 적용됩니다.</p>

      <p>공고일자 : 2020년 12월 13일</p>
      <p>공고일자 : 2020년 12월 13일</p>
      <p>변경내역</p>
      <p>2021년 5월 1일: 초안</p>
      <p>2021년 9월 1일: 개인정보 처리 해당 서비스 추가</p>
      <p>2023년 12월 13일: 위탁업체 및 목적 추가</p>
    </div>
  );
};
